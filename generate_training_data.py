...
def main():
    ...
    parser.add_argument('--train_corpus', type=str, default=r"C:\Users\14389\Desktop\test_cnn\\")
    parser.add_argument("--output_dir", type=Path, default="./data/cnn_processed/")
    ...
    parser.add_argument("--task_name", type=str, default='cnn',
                        help="Dataset name")
    ...
    with DocumentDatabase(reduce_memory=args.reduce_memory) as docs:
        train_file = os.listdir(args.train_corpus)
        doc = []
        lines_to_add = []
        iterations = 0
        for file in train_file:
            filepath = Path(args.train_corpus + file)
