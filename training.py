...
def main():
    ...
    parser.add_argument('--pregenerated_data', type=Path, default=r"D:\Project\POINTER-master\data\cnn_processed")
    parser.add_argument('--output_dir', type=Path, default=r"D:\Project\POINTER-master\ckpt\cnn_model")
    parser.add_argument("--bert_model", type=str,  default=r"D:\Project\POINTER-master\ckpt\wiki_model",help="Bert pre-trained model selected in the list: bert-base-uncased, "
